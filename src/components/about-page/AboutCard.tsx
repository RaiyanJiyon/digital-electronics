    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-11/12 max-w-[1920px] mx-auto">
        {services.map((service, index) => (
          <div key={index} className="flex flex-col items-center justify-center p-6 bg-white border rounded-lg shadow-md hover:shadow-lg hover:text-white transition-all duration-300">
            {/* Icon Section */}
